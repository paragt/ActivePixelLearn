...
std::vector< std::vector<float> >& Dataset::get_features(){
...
void Dataset::get_submatrix(std::vector< std::vector<float> >& inputMat,
...
void Dataset::get_random_submatrix(std::vector< std::vector<float> >& inputMat,
			       std::vector<int>& inputLabels,
			       unsigned int nrows,
			       std::vector< std::vector<float> >& outputMat,
			       std::vector<int>& outputLabels)
...
void Dataset::get_train_test_set(std::vector< std::vector<float> >& inputMat,
			       std::vector<int>& inputLabels,
			       unsigned int nrows,
			       std::vector< std::vector<float> >& trnMat,
			       std::vector<int>& trnLabels, 
