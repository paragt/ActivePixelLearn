...
public:
    ...
    H5Write(const char* filename, const char* datasetname, int rank, const hsize_t* dimsf, float* pdata){
	 ...
	 * Write the data to the dataset using default transfer properties.
	 */
	status = H5Dwrite(dataset, H5T_NATIVE_FLOAT, H5S_ALL, H5S_ALL, H5P_DEFAULT,  pdata);
